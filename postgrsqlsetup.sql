...
CREATE TABLE resource (  
  ...
  currentleadid int NOT NULL,
  currentparentid int NOT NULL,
...
insert into userdetails(userid,username,password,admin) values(1,'admin','19223a7bbd7325516f069df18b50','Y');
